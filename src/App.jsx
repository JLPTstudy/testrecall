            ...
            {loginSent ? (
              ...
              <>
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg py-2.5 text-sm font-medium hover:bg-gray-50 mb-4"
                >
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-xs text-gray-400">或用邮箱验证码</span>
                  <div className="flex-1 h-px bg-gray-200"/>
                </div>
                <input
                  type="email"
