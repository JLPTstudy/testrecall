...
【第二步：提取范围】
- 【最高优先级】题干句子中被考察/被下划线的词，是整道题的核心考点，必须第一个提取。例：「人の話はにわかには信じられない」中，にわかに就是被考察词，必须提取。
- 题目正文（题干句）中出现的所有值得记忆的词汇，与选项同等重要，不能只抓选项而漏掉题干词汇
- 全部选项中的词汇也要提取（选择题4个选项都要检查）
- 不因"太普通"而跳过（如製作する、手法、活用する、にわかに等都要抓）
- 只排除极基础词：する/ある/いる/来る/行く/見る 等常用基础动词、助词（が/は/で/に/て）、数字
